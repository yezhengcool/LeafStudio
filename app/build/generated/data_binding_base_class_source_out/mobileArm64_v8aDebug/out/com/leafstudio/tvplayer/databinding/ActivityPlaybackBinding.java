...
public final class ActivityPlaybackBinding implements ViewBinding {
  ...
  private ActivityPlaybackBinding(@NonNull FrameLayout rootView,
      ...
      @NonNull ImageView ivLoadingBackground, @NonNull LinearLayout layoutNetworkStatus,
      ...
      @NonNull TextView tvMarquee, @NonNull TextView tvNetworkMessage,
      @NonNull TextView tvResolution, @NonNull TextView tvVideoResolution,
    ...
    this.tvNetworkMessage = tvNetworkMessage;
  ...
  public static ActivityPlaybackBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tv_network_message;
      TextView tvNetworkMessage = ViewBindings.findChildViewById(rootView, id);
      if (tvNetworkMessage == null) {
        break missingId;
      }
      ...
      return new ActivityPlaybackBinding((FrameLayout) rootView, bottomControlsContainer,
          ...
          flIjkContainer, ivLoadingBackground, layoutNetworkStatus, playerView,
          binding_sidebarChannelRoot, binding_sidebarRouteRoot, topStatusContainer, tvChannelNumber,
          tvCurrentTime, tvMarquee, tvNetworkMessage, tvResolution, tvVideoResolution, tvWeather);
    }
