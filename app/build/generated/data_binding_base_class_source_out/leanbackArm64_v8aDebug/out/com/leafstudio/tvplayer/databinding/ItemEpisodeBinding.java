...
public final class ItemEpisodeBinding implements ViewBinding {
  ...
  private ItemEpisodeBinding(@NonNull TextView rootView, @NonNull TextView tvEpisodeName) {
  ...
  public static ItemEpisodeBinding bind(@NonNull View rootView) {
    ...
    TextView tvEpisodeName = (TextView) rootView;

    return new ItemEpisodeBinding((TextView) rootView, tvEpisodeName);
  }
}
